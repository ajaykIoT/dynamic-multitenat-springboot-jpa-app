package com.akumar1.dynamic.multitenant.tenant.config;
...
@ComponentScan(basePackages = { "com.akumar1.dynamic.multitenant.tenant.repository", "com.akumar1.dynamic.multitenant.tenant.entity" })
@EnableJpaRepositories(basePackages = {"com.akumar1.dynamic.multitenant.tenant.repository", "com.akumar1.dynamic.multitenant.tenant.service" },
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.akumar1.dynamic.multitenant");
